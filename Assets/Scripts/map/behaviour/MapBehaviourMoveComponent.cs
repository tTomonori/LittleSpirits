...
public class MapBehaviourMoveComponent : MapBehaviour {
    public Collider2D mCollider;
    ///自分のマップ属性
    private MapAttributeBehaviour mMyAttributeBehaviour;
    private void Awake(){
    ...
    private MapPassType confirmPassBy(Vector2 aVector){
        ...
        foreach (Collider2D tCollider in tColliders){
            ...
            if (tAttributeBehaviour == null) { continue; }//衝突した相手にマップ属性なし(通過してOK)
